...
Målområde looks like a Skadis board but the layout is slightly different. Skadis is 20x20mm grid, but Målområde is 20x21.5mm. So models made for Skadis might not fit.
...
### Example of IKEA Målområde annoying new layout: Here is an example of how Målområde grid looks like, so you are sure the result will fit:
...
Distance between each hole in the same row = 40mm Distance between row 1 and row 2 = 21.5mm Distance between between row 1 and row 3 = 42.5mm Row 1 and row 2 are offset by 20mm
